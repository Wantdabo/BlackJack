...
public class Lua
{
    ...
    private LuaFunction handleSocketInfoFunc;
    ...
    private Lua()
    {
        ...
        handleSocketInfoFunc = LuaEnv.Global.Get<LuaFunction>(GlobalValues.FUNC_HANDLE_SOCKET_INFO);
    }
    ...
    public void HandleSocketInfo(SocketInfo _socketInfo) {
        handleSocketInfoFunc.Call(_socketInfo);
    }
